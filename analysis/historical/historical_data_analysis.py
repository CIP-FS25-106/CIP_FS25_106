...
def create_overview_plot(df: pd.DataFrame) -> None:
    """
    ...
    try:
        ...
        plt.tight_layout()
        plt.show()
        logger.info("Overview plot displayed")
    except Exception as e:
        logger.error(f"Error creating overview plot: {e}")


def create_category_delay_barplot(df: pd.DataFrame) -> None:
    """
    ...
    try:
        ...
        plt.tight_layout()
        plt.show()
        logger.info("Category delay barplot displayed")
    except Exception as e:
        logger.error(f"Error creating category delay barplot: {e}")


def create_delay_category_barplot(df: pd.DataFrame, stations: List[str]) -> None:
    """
    ...
    try:
        ...
        plt.tight_layout()
        plt.show()
        logger.info("Delay category barplot displayed")
    except Exception as e:
        logger.error(f"Error creating delay category barplot: {e}")


def create_bubble_chart(df: pd.DataFrame, stations: List[str]) -> None:
    """
    ...
    try:
        ...
        plt.tight_layout()
        plt.show()
        logger.info("Bubble chart displayed")
    except Exception as e:
...
def create_weekday_heatmap(df: pd.DataFrame) -> None:
    ...
    try:
        ...
        plt.tight_layout()
        plt.show()
        logger.info("Weekday heatmap displayed")
    except Exception as e:
        logger.error(f"Error creating weekday heatmap: {e}")


def create_hourly_lineplot(df: pd.DataFrame) -> None:
    """
    ...
    try:
        ...
        plt.tight_layout()
        plt.show()
        logger.info("Hourly line plot displayed")
    except Exception as e:
...
def main():
    ...
    try:
        ...
        create_category_delay_barplot(df)
        create_delay_category_barplot(df, stations)
        create_bubble_chart(df, stations)
        create_weekday_heatmap(df)
        create_hourly_lineplot(df)
