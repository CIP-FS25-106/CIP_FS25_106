...
###################################################################
# 3. Barplot: Percentage of delay category
###################################################################
...
###################################################################
# 4. Bubble Chart: Delay Frequency vs Severity
###################################################################
...
plt.grid(True)
plt.legend(fontsize='small')  # or fontsize=8 for a specific size
plt.tight_layout()
plt.show()